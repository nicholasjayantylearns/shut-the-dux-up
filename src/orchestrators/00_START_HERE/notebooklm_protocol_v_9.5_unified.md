...
- **Compliant with v9.5 schema requirements** including evidence status and cross-object references
...
- Understand compliance requirements and validation rules including evidence status requirements
...
- Include evidence status for each problem (supporting/refuting/research_gap/neutral)
...
- Include evidence status and cross-references to related problems and results
...
- Include evidence status and cross-references to related problems and behaviors
